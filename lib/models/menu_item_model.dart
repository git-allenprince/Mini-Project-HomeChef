...
// final String imageUrl;''
  ...
  static List<MenuItem> menuItems=[
    ...
    MenuItem(id: 3, homemakerId: 3, name: 'Dosa', category: 'Breakfast',description: 'With curry,Serves 1', price: 75),
    MenuItem(id: 4, homemakerId: 1, name: 'Idli', category: 'Breakfast',description: 'With curry,Serves 1', price: 65),
    MenuItem(id: 5, homemakerId: 2, name: 'Idli', category: 'Breakfast',description: 'With curry,Serves 1', price: 65),
    ...
    MenuItem(id: 8, homemakerId: 2, name: 'Appam', category: 'Breakfast',description: 'With curry,Serves 1', price: 55),
